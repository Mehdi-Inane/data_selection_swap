#!/bin/bash
#SBATCH --job-name=kl_selection_experiments_cifar100
#SBATCH --output=logs/cifar100_kl_select_%A_%a.txt
#SBATCH --error=logs/cifar100_kl_select_%A_%a.txt
...
CHECKPOINT_DIR="/home/mila/a/ahmedm/scratch/data_selection_swap/cifar100/checkpoints"
...
echo ""
echo "--------------------------------------------------"
echo " Running KL-Faithful Selection | fraction=$FRACTION | seed=$SEED"
echo "--------------------------------------------------"
